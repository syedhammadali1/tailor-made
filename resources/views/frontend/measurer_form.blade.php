    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-lg-6 text-center text-lg-left">
                <h1 class="fw-600 h4">{{ translate('Register')}}</h1>
            </div>
            <div class="col-lg-6">
                <ul class="breadcrumb bg-transparent p-0 justify-content-center justify-content-lg-end">
                    ...
                    <li class="text-dark fw-600 breadcrumb-item">
                        <a class="text-reset" href="{{ route('measurer.register-measurer') }}">"{{ translate('Register')}}"</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xxl-5 col-xl-6 col-md-8 mx-auto">
                <form id="shop" class="" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if (!Auth::check())
                        <div class="bg-white rounded shadow-sm mb-3">
                            ...
                            <div class="p-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control {{ $errors->has('password_confirmation') ? ' is-invalid' : '' }} " placeholder="{{  translate('Confirm Password') }}" name="password_confirmation">
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-primary fw-600">{{ translate('Register')}}</button>
                    </div>
                </form>
            </div>
        </div>
