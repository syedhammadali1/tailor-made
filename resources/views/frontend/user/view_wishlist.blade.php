                ...
                <div class="col-xxl-3 col-xl-4 col-lg-3 col-md-4 col-sm-6" id="wishlist_{{ $wishlist->id }}">
                    <div class="card mb-2 shadow-sm">
                        ...
                        <div class="card-footer">
                            ...
                            @if(!$wishlist->product->is_personalise)
                            ...
                            @else
                                <a href="{{ route('product', $wishlist->product->slug) }}" class="btn btn-sm btn-block btn-primary ml-3">
                                    <i class="la la-shopping-cart mr-2"></i>{{ translate('Request')}}
                                </a>
                            @endif
                        </div>
                    </div>
