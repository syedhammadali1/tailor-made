                ...
                <table class="table aiz-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th data-breakpoints="lg">{{ translate('Rejected Status')}}</th>
                            ...
                            @if($appointment != null)
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      <td>
                                        @if (is_null(@$appointment->measurement->is_rejected))
                                             -
                                        @elseIf(@$appointment->measurement->is_rejected == 1)
                                            rejected
                                         @elseIf(@$appointment->measurement->is_rejected == 0)
                                           Accepted
                                        @endif
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a href="javascript:;" class="dropdown-item m-add-measurements" a-m-url="{{ route("measurer-measurement", encrypt($appointment->id)) }}">View Your Measurements</a>
                                                @if (is_null(@$appointment->measurement->is_rejected) && auth()->user()->user_type == 'customer')
                                                <a href="{{route('reject_measurment',['measurment_id' => encrypt($appointment->measurement->id),'status' => 0])}}" class="dropdown-item">Accept</a>
                                                <a href="{{route('reject_measurment',['measurment_id' => encrypt($appointment->measurement->id),'status' => 1])}}" class="dropdown-item">Reject</a>
                                                @endif

                                                {{-- @if ($appointment->product->personalizeProductTypeName != null )
                                                @if ($appointment->product->personalizeProductTypeName->slug != "clothing" || $appointment->product->personalizeProductTypeName->slug != "shoes") --}}

                                                {{-- @endif
                                                @endif --}}


                                                {{-- <a class="dropdown-item m-add-measurements-video" href="{{route('appointments_video_customer', ['id' => $appointment->id])}}">Measurement With Video</a> --}}
                    ...
                    <div class="p-3">
                        <form class="form-default" role="form" method="POST" enctype="multipart/form-data">
                            ...
                            {{-- @if ($appointment->product->personalizeProductTypeName->slug == 'clothing' || $appointment->product->personalizeProductTypeName->slug == "shoes") --}}
                                <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group videoSection" style="display: none">
                                        <label for="measurements_video">Measurements Video</label>
                                        <video width="320" height="240" controls autoplay id="videoID">
            ...
            $(document).on('click', '.m-add-measurements', function(e) {
                ...
                $.ajax({
                    ...
                    $.each(response.data, function(key, val){
                        ...
                        var path = response.data.measurement_video;
                        ...
                        $('.videoSection').show();
                         ...
                         $('#videoID').attr('src', videoUrl+"/"+path).show();

                        //  video.src = '{{ URL::asset('public/videos/F75eBwpzA3ySNf780c8BujnnEGXKq963cZqAwuZJ.webm') }}';
