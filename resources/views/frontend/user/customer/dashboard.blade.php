...
@php
   $customer_addresses =   auth()->user()->customer_addresses;
   if($customer_addresses){
    $address_id = $customer_addresses->id;
   }else{
    $address_id = null;
   }
...
<div class="aiz-titlebar mt-2 mb-4">
    <div class="row align-items-center">
        ...
        <div class="col-md-6 d-flex justify-content-end">
            <button type="button" data-toggle="modal" data-target="#find-nearby-modal" data-customer-id="{{auth()->id()}}"  data-address-id="{{$address_id}}"  class="f-m-btn-nearby btn btn-soft-primary mr-2 find-measurer-btn fw-600" >
    ...
    <div class="col-md-12">
        {{-- <div class="card">
            ...
            <div class="card-body">
             ...
             <!-- Address -->
    <div class="card">
        <div class="col-lg-6 mx-auto mt-4" onclick="add_new_address()">
    ...
    <div class="modal-dialog modal-dialog-zoom" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="p-3">
                    <form class="form-default find-measurer-form" role="form" action="{{ route('measurer.conversations.create') }}" method="post">
                        @csrf
