                        ...
                        @endphp
                            ...
                            @if($appointment != null)
                                <tr>
                                    ...
                                    <td>
                                        $ {{ $appointment->measurer_commission}}
                                    </td>
                                    <td>
                                                ...
                                                @else
                                                    {{-- @isset($appointment->product->personalizeProductTypeName) --}}
                                                        {{-- @if($appointment->product->personalizeProductTypeName->slug == 'clothing') --}}
                                                            <a class="dropdown-item m-add-measurements" href="javascript:;" a-m-url="{{ route("direct-measurer-measurement", encrypt(@$appointment->id)) }}">Clothes Measurement</a>
                                                        {{-- @endif --}}
                                                        {{-- @if($appointment->product->personalizeProductTypeName->slug == 'shoes') --}}
                                                            <a class="dropdown-item m-add-measurements-shoes" href="javascript:;" a-m-url="{{ route("direct-measurer-measurement", encrypt(@$appointment->id)) }}">Shoes Measurement</a>
...
{{--                                <input type="hidden" name="measurements_image_h">--}}
                                ...
                                <input type="hidden" name="user_id" id="clothes_user_id">
                ...
                <div class="p-0">
                    <form class="form-default" role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="hidden" name="user_id" id="shoes_user_id">
                            <button type="submit" class="btn btn-primary btn-block fw-600">{{  translate('Submit') }}</button>
                        </div>
                        <div class="alert alert-success  m-msg-shows"></div>
{{--                        <div class="alert alert-danger  m-error-msg-shows"></div>--}}
                    </form>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $(function(){
            ...
            $(document).on('click', '.m-add-measurements', function(e) {
                ...
                $('#clothes_user_id').val($(this).data('user-id'));
            ...
            $(document).on('click', '.m-add-measurements-shoes', function(e) {
                $('#shoes_user_id').val($(this).data('user-id'));
