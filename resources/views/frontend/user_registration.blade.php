...
@section('script')
    ...
    <script type="text/javascript">
        $('#user_type').change(function() {
            ...
            if(val == 'seller'){
                $(".append_div").html('<div class="form-group"><input type="text" class="form-control" placeholder="{{ translate('Shop Name')}}" name="shop_name" required></div><div class="form-group"><input type="text" class="form-control mb-3" placeholder="{{ translate('Address')}}" name="shop_address" required></div>');
            }
