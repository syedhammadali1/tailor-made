        ...
        @if (get_setting('google_map') == 0)
            ...
            <div class="row">
                ...
                <div class="col-md-10" id="">
                    <input type="hidden" class="form-control mb-3" id="edit_longitude" name="longitude" value="{{ $address_data->longitude }}" readonly="">
                </div>
            </div>
            <div class="row">
                {{-- <div class="col-md-2" id="">
                ...
                <div class="col-md-10" id="">
                    <input type="hidden" class="form-control mb-3" id="edit_latitude" name="latitude" value="{{ $address_data->latitude }}" readonly="">
                </div>
            </div>
        @endif
