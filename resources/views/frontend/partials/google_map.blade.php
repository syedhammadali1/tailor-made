...
function geoLocationInit() {
    ...
    function success(position) {
        ...
        initialize(latval,lngval,id_format='');


    }

    function fail() {
        alert("Can't find location allow please the permission");
    }


    function initialize(lat=0, long=0, id_format='') {
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA2a2SFmnO2daH_Jjv45AKIKxtqtwEqFl4&libraries=places&language=en&callback=initialize" async defer></script>
