...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">{{translate('Edit Measurer Information')}}</h5>
</div>

<div class="col-lg-6 mx-auto">
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{translate('Measurer Information')}}</h5>
        </div>

        <div class="card-body">
          <form action="{{ route('measurer.update', $user->id) }}" method="POST">
