                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items- py-3">
                                        <div class="media text-inherit">
                                            <div class="media-body">
                                                ...
                                                @elseif($notification->type == 'App\Notifications\ProfileApprovedByAdminNotification')
                                            <div>
                                                <div>
                                                    <p class="mb-1 text-truncate-2">
                                                        {{translate('New user has been registered')}}
                                                    </p>
                                                    <small class="text-muted">
                                                        {{ date("F j Y, g:i a", strtotime($notification->created_at)) }}
                                                    </small>
                                                ...
                                                {{-- <div class="d-flex justify-content-between">
                                                    <button class="btn btn-soft-primary btn-sm d-flex align-items-center approve" data-user-id={{$notification->data['user_id']}}>approved</button>
                                                    <button class="btn btn-soft-danger btn-sm d-flex align-items-center reject">reject</button>
                                                </div> --}}
