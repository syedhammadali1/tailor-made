    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{route('getAllMeasurments')}}" class="aiz-side-nav-link">
                        <i class="las la-home aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('Complete Measurments')}}</span>
                    </a>
                </li>
                ...
                @if((Auth::user()->user_type == 'admin' || in_array('9', json_decode(Auth::user()->staff->role->permissions))) && get_setting('vendor_system_activation') == 1)
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('measurer.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('All Measurer') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_membership_requests') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Membership Requests') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('23', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all.models') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all.models'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('All Models') }}</span>
                                </a>
                            </li>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('11', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('crazy_sunday.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Crazy Sunday') }}</span>
                                </a>
                            </li>
