            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="md">{{ translate('Personalised')}}</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    {{-- <input type="checkbox"  {{ $product->is_personalise == 1 ? "checked" : "" }} >
                                    <span class="slider round"></span> --}}
                                    @if( $product->is_personalise == 1)
                                        <i class="las h4 la-check"></i>
                                    @else
                                        <i class="las h6 la-minus"></i>
                                    @endif
                                </label>
                            </td>
                            <td>
