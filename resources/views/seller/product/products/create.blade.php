                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input type="checkbox" name="is_personalise" id="is_personalise" value="1" >
                                <span></span>
                            </label>
                     ...
                     <div class="form-group row" id="personalize_product_type_id" style="display: none">
            ...
            @isset(auth()->user()->userProfileById->profileName)
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" name="is_crazy_sunday" value="1" checked="">
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        {{--                @else--}}
                        {{--                    <p>--}}
                        {{--                        {{ translate('Crazy Sunday activation is maintained by Admin.') }}--}}
                        {{--                    </p>--}}
                    </div>
                </div>
                @endif
