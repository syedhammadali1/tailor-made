...
use App\Models\Cart;
use App\Models\PersonalizeProductType;
use Carbon\Carbon;
use Combinations;
...
//        CoreComponentRepository::initializeCache();
        ...
        $personalise_product_types = PersonalizeProductType::get();
        ...
        return view('backend.product.products.create', compact('categories','personalise_product_types'));
    }
...
//        CoreComponentRepository::initializeCache();
        ...
        $categories = Category::where('parent_id', 0)
            ...
            ->with('childrenCategories')
            ->get();
        return view('backend.product.products.edit', compact('product', 'categories', 'tags', 'lang','personalise_product_types'));
    }
