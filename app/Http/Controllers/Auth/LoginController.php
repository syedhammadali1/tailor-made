...
class LoginController extends Controller
{
    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        if($user->is_approved_by_admin == 0 && in_array($user->user_type,['seller','measurer'])){
            flash('Your Account is in pending');
            return redirect()->back();
        }elseif ($user->is_approved_by_admin == 2 && in_array($user->user_type,['seller','measurer'])) {
            flash('Your Account was rejected');
            return redirect()->back();
        }
    }
