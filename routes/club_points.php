...
//todo you have to add "club_point_registration_rate" , "club_point_review_rate" in business_settings DB
...
Route::group(['middleware' => ['user', 'verified']], function(){
    ...
    Route::get('convert-time-to-points', [ClubPointController::class, 'convert_time_to_points'])->name('convert_time_to_points');
});
