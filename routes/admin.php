...
use App\Http\Controllers\CrazySundayController;
...
Route::get('/approved', [AdminController::class, 'approvedByAdmin'])->name('approvedByAdmin')->middleware(['auth', 'admin']);
Route::get('/getAllMeasurments', [AdminController::class, 'getAllMeasurments'])->name('getAllMeasurments')->middleware(['auth', 'admin']);
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(SellerController::class)->group(function () {
        ...
        Route::post('/sellers/approved/premium', 'updateIspremium')->name('sellers.updateIspremium');
        Route::post('membership/request/update',  [SellerRequestController::class,'update_membership_status'])->name('sellers.update_membership_status');

        Route::get('/measurer/index', 'measurer_index')->name('measurer.index');
        Route::get('/measurer/destroy/{id}', 'measurer_destory')->name('measurer.destroy');
        Route::get('/measurer/edit/{id}', 'measurer_edit')->name('measurer.edit');
        Route::patch('/measurer/update/{id}', 'measurer_update')->name('measurer.update');
    ...
    Route::get('all/membership/request',[SellerRequestController::class, 'all_membership_requests'])->name('all_membership_requests');
    ...
    Route::resource('crazy_sunday', CrazySundayController::class);
    Route::post('/crazy_sunday/update_status', [CrazySundayController::class,'update_status'])->name('crazy_sunday.update_status');
